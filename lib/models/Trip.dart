...
class Trip extends amplify_core.Model {
  ...
  Trip copyWithModelFieldValues(
    ...
    return Trip._internal(
        ...
        tripImageUrl:
            tripImageUrl == null ? this.tripImageUrl : tripImageUrl.value,
        tripImageKey:
            tripImageKey == null ? this.tripImageKey : tripImageKey.value);
  }
  ...
  static final amplify_core.QueryModelIdentifier<TripModelIdentifier>
      MODEL_IDENTIFIER =
      amplify_core.QueryModelIdentifier<TripModelIdentifier>();
  ...
  static final TRIPIMAGEURL =
      amplify_core.QueryField(fieldName: "tripImageUrl");
  static final TRIPIMAGEKEY =
      amplify_core.QueryField(fieldName: "tripImageKey");
